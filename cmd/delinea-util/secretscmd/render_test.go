...
func everyFinding(t *testing.T) []section {
	...
	out = append(out, section{title: "misc", findings: []finding{
		...
		warn("DELINEA_TOOLS_PASWORD", "not read by delinea-util; did you mean DELINEA_TOOLS_PASSWORD?"),
		warn("DELINEA_TOOLS_TIMEOUTS", "not read by delinea-util; did you mean DELINEA_TOOLS_TIMEOUT?"),
